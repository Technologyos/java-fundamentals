...
public class MethodReferenceTypes {
    ...
    public static void boundMethodReferences(){
        ...
        System.out.println(lowerL.get()); // jose armando
        System.out.println(lowerMR.get());// jose armando
        ...
        System.out.println(titleL.test("Jose")); // true
        System.out.println(titleMR.test("Armando"));// false
    }
